...
<details><summary>📊 Pattern Counts — GitHub: 515 partner types, 443 with push protection | ADO: 332 partner types (Updated: 2026-06-03)</summary>

# GitHub

| [Secret Protection Inventory](https://docs.github.com/en/enterprise-cloud@latest/code-security/reference/secret-security/supported-secret-scanning-patterns) |2026-06-03 05:18:07Z |
| --- | --- |
...
| Number of Secret Types with Validity Check | 147 |
| Number of Secret Types with Base64 Support | 21 |
| Number of Secret Types with Extended Metadata | 33 |
...
# Azure DevOps
| Secret Scanning Inventory |2026-06-03 05:18:07Z |
| --- | --- |
